...
def run_beam_search(sess, model, vocab, batch):
  ...
  while steps < FLAGS.max_dec_steps and len(results) < FLAGS.beam_size:
    ...
    # insert the word has meet to the visit_word
    # print('last token',latest_tokens)
    # visit_word.extend(latest_tokens)
    ...
    # print(topk_ids.shape,topk_log_probs.shape)
    ...
    for i in xrange(num_orig_hyps):
      ...
      for j in xrange(FLAGS.max_enc_steps):
    ...
    for h in sort_hyps(all_hyps): # in order of most likely h
      if len(set(h.tokens)) != len(h.tokens):
        continue
      # print(h.tokens)
