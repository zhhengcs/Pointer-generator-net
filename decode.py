...
class BeamSearchDecoder(object):
  ...
  def decode(self):
    ...
    while True:
      # batch = dict()
      # batch['data'] = self._batcher['data'].next_batch()  # 1 example repeated across batch
      # batch['POS'] = self._batcher['POS'].next_batch()
      ...
      decoded_words = data.outputids2words(output_ids, self._vocab['data'], (batch.art_oovs[0] if FLAGS.pointer_gen else None))
